...
public class DefaultClusterServerInitFunc implements InitFunc {
    ...
    private void initDefaultEntityWriters() {
        ...
        ResponseDataWriterRegistry.addWriter(ClusterConstants.MSG_TYPE_CONCURRENT_FLOW_KEEP, new ConcurrentFlowReleaseResponseDataWriter());
    }
    ...
    private void initDefaultEntityDecoders() {
        ...
        RequestDataDecodeRegistry.addDecoder(ClusterConstants.MSG_TYPE_CONCURRENT_FLOW_RELEASE, new ConcurrentFlowReleaseRequestDatatDecoder());
        RequestDataDecodeRegistry.addDecoder(ClusterConstants.MSG_TYPE_CONCURRENT_FLOW_KEEP, new ConcurrentFlowReleaseRequestDatatDecoder());
    }
