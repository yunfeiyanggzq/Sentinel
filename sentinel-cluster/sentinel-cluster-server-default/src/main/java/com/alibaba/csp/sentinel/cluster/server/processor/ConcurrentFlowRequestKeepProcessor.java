...
@RequestType(ClusterConstants.MSG_TYPE_CONCURRENT_FLOW_KEEP)
public class ConcurrentFlowRequestKeepProcessor implements RequestProcessor<ConcurrentFlowReleaseRequestData, ConcurrentFlowReleaseResponseData> {
    @Override
    public ClusterResponse<ConcurrentFlowReleaseResponseData> processRequest(ChannelHandlerContext ctx, ClusterRequest<ConcurrentFlowReleaseRequestData> request) {
        ...
        TokenResult result = tokenService.keepConcurrentToken(tokenId);
