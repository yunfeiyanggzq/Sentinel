...
public class DefaultClusterClientInitFunc implements InitFunc {
    ...
    private void initDefaultEntityWriters() {
        ...
        RequestDataWriterRegistry.addWriter(ClientConstants.TYPE_PARAM_CONCURRENT_FLOW_ACQUIRE, new ConcurrentFlowAcquireRequestDataWriter());
        RequestDataWriterRegistry.addWriter(ClientConstants.TYPE_PARAM_CONCURRENT_FLOW_RELEASE, new ConcurrentFlowReleaseRequestDataWriter());
    ...
    private void initDefaultEntityDecoders() {
        ...
        ResponseDataDecodeRegistry.addDecoder(ClientConstants.TYPE_PARAM_CONCURRENT_FLOW_ACQUIRE, new ConcurrentFlowAcquireResponseDataDecoder());
        ResponseDataDecodeRegistry.addDecoder(ClientConstants.TYPE_PARAM_CONCURRENT_FLOW_RELEASE, new ConcurrentFlowReleaseResponseDataDecoder());
