...
public class DefaultClusterClientInitFunc implements InitFunc {
    ...
    private void initDefaultEntityWriters() {
        ...
        RequestDataWriterRegistry.addWriter(ClientConstants.TYPE_CONCURRENT_FLOW_KEEP, new ConcurrentFlowReleaseRequestDataWriter());
    ...
    private void initDefaultEntityDecoders() {
        ...
        ResponseDataDecodeRegistry.addDecoder(ClientConstants.TYPE_CONCURRENT_FLOW_KEEP, new ConcurrentFlowReleaseResponseDataDecoder());
    }
}
